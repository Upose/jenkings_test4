      ...
      <el-form label-width="90px" class="admin-form">
        <div class="form-set-content">
          ...
          <el-form-item label="标题名称" prop="name">
            <el-input v-model="postForm.title" placeholder="请输入名称" maxlength="50" minlength="2" show-word-limit></el-input>
          </el-form-item>
...
export default {
  ...
  methods: {
    /****保存设置信息*******/
    submitForm() {
      this.$emit('closeCommon',{data:this.postForm,type:'title'});
    },
    //删除背景
    delBGImg() {
      this.postForm.bgimg = '';
