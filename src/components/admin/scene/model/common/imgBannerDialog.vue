...
<template>
  <div class="tag-box">
    <el-dialog append-to-body title="图片轮播组件设置" :visible.sync="dialogBulk" width="630px" :close-on-click-modal="false" :before-close="handleClose">
        ...
        <div class="form-set-content">
          <el-form-item label="图片" prop="logo">
            <div class="up-img w100" :style="{'background-image':'url('+(postForm.bgimg?(fileUrl+postForm.bgimg):'')+')'}">
              <div><img src="@/assets/admin/img/icon-upload.png" /><span>图片上传</span></div>
          ...
          <el-form-item label="标题" prop="name">
            <el-input v-model="postForm.title" placeholder="请输入标题" maxlength="50" minlength="2" show-word-limit></el-input>
          </el-form-item>
