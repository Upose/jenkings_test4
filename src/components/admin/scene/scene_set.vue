            ...
            <div class="drag-container" ref="dragContainer" :class="postForm.themeColor||'template1'">
              <div class="drag-warp-bg jl_vip_zt_warp_preview" :style="{'zoom':ratio_num}">
                ...
                <div class="scene-warp-bg" :style="sceenBgImg(postForm.sceneScreens[screen_cu])">
                  ...
                  <div class="jl_vip_zt_warp_hf foot" :class="is_HF=='foot'?'mask-layer-active':''" v-show="postForm.footerTemplate && postForm.footerTemplate.router && postForm.footerTemplate.templateCode && (postForm.layoutId== 2?(screen_cu==(screen_list.length-1)):true)" style="min-height:90px">
