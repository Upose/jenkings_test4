<template>
  <div class="list-warp">
    ...
    <news_sys></news_sys>
    <br>
    <activities_and_lectures></activities_and_lectures>
    <br>
...
import footer_sys from "@/components/web/model/scsf/footer_sys";
...
export default {
  created() { },
  components: { 
    academic_result, database_nav_sys,footer_sys,database_nav_sys1, header_sys, hot_services, literature_project_sys, news_sys,activities_and_lectures, unified_retrieval_sys, 
